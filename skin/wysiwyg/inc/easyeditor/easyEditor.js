...
var easyConfig = {
	...
	width : "100%",				//±âº» width
	height : "250px",			//±âº» height
	//----------------------------------------------------
	filepath : ".",	
	imgpath : "/include/miniboard/skin/wysiwyg/inc/easyeditor/img/easy",		//¹öÆ° ÀÌ¹ÌÁö°æ·Î
...
function (self){ 
	window.open("/include/miniboard/skin/wysiwyg/inc/easyeditor/table.html","table","width=400,height=220,status=1");
} ];
